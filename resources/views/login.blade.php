	...
	<div class="h-25"></div>
						<div class="card  box-shadow-1 ">
							<div class="card-header row m-0">
								...
								<img src="{{asset('/assets/img/brand/favicon.png')}}" class="" style="width: 60px;" alt="">
								</div>
								...
								<form action="{{route('login')}}" method="post" >
									...
									<div class="">
										...
										<div class="form-group">
											...
											<input type="password" class="form-control" id="password" name="password" placeholder="كلمه المرور">
											@error('password')
											<span class="text-danger">{{$message}}</span>
										@enderror
										</div>
