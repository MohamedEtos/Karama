										...
										<div class="main-signup-header">
											...
											<form action="{{route('signup')}}" method="POST">
												...
												<div class="form-group">
													<label>usercode </label> <input class="form-control" name="usercode" placeholder="usercode" type="text">
												</div>
												<div class="form-group">
													<label>first name </label> <input class="form-control" name="firstname" placeholder="first name" type="text">
												</div>
												<div class="form-group">
													<label>last name </label> <input class="form-control" name="lastname" placeholder="last name" type="text">
												</div>
												<div class="form-group">
													<label>phone number </label> <input class="form-control" name="phonenumber" placeholder="phone number" type="text">
												</div>
