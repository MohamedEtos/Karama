		...
		<!-- End Modal effects-->
				...
				<div class="dropdown main-profile-menu p-0 nav nav-item nav-link">
					...
					<div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="{{route('admin.dashboard')}}"><i class="fa-solid fa-arrows-rotate pl-2"></i>لوحه التحكم</a>
                        @endif
                        @if (Auth::User()->subtype == 'merchant')
                        <a class="dropdown-item" href="{{route('merchant')}}"><i class="fa-solid fa-arrows-rotate pl-2"></i>لوحه التحكم</a>
                        @endif
