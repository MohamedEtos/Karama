						...
						<div class="card">
							...
							<div class="card-body">
								<div class="mb-4 main-content-label">المعلومات الشخصيه والاشتراكات </div>
									...
									<div class="form-group ">
										<div class="row">
											<div class="avatar-upload image_uploader_profile">
									...
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<textarea class="form-control" name="example-textarea-input" rows="2"  placeholder="رقم البنايه / الشارع / المنطقه" ></textarea>
											</div>
										</div>
									</div>

									<div class="mb-4 main-content-label">التواصل والسوشيال ميديا</div>
									...
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<input type="text" class="form-control"   placeholder="phone number" value="{{Auth::user()->phone_number}} ">
											</div>
										</div>
									</div>
									...
									<div class="form-group ">
										<div class="row">
											<div class="col-md-3">
												<label class="form-label">الموقع الالكتوني</label>
											</div>
											<div class="col-md-9">
												<input type="text" class="form-control"   placeholder="www.Karama-SC.com" value="">
											</div>
										</div>
									</div>
									<div class="form-group ">
										<div class="row">
											<div class="col-md-3">
												<label class="form-label">سوشيال ميديا</label>
											</div>
											<div class="col-md-9">
												<input type="text" class="form-control"   placeholder="https://www.facebook.com/mohamed.etos" value="">
											</div>
										</div>
									</div>
									
									<div class="mb-4 main-content-label">نبذه عن المتجر</div>
									...
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<textarea type="text" class="form-control"   placeholder="شركه ماستر كوتش تاسست عام...." value=""></textarea>
											</div>
										</div>
									</div>
