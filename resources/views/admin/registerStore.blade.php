...
@section('page-header')
				...
				<div class="breadcrumb-header alert alert-light rounded justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">المتجرات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ اضافه منتج جديد</span>
						</div>
					</div>
						...
						<div class="card">
							<div class="card-body">
								<form id="product_data" class="row g-3 needs-validation" enctype="multipart/form-data" novalidate >
									...
									<div class="col-md-4">
									  <label for="validationCustom01" class="form-label">كود الاشتراك</label>
									  <input type="text" minlength="3"  name="name" maxlength="15" class="form-control randCode" placeholder="كود الاشتراك " id="validationCustom01" required>
									  <i class="fa-solid fa-wand-sparkles errspan"></i>
									  <div class="valid-feedback">
										ممتاز !
									  </div>
										<div class="invalid-feedback" id="name_error">
											يجب ان يكون كود المتجر من 8 ارقام
								  		</div>
									</div>
									...
									<div class="col-md-4">
										...
										<input type="text" minlength="3" name="name" maxlength="15" class="form-control" placeholder="karam@karam.com" id="validationCustom01" required>
										<div class="valid-feedback">
										  ممتاز !
										</div>
										<div class="invalid-feedback" id="name_error">
									...
									<div class="col-md-4">
										...
										<input type="text" minlength="3" name="name" maxlength="15" class="form-control randpass	" placeholder="اكتب كلمه مرور" id="validationCustom01" required>
										<div class="valid-feedback">
										  ممتاز !
										</div>
										<div class="invalid-feedback" id="name_error">
									...
									<div class="col-md-4 mt-4">
										<label for="validationCustom01" class="form-label">وصف المتجر</label>
										...
										<div class="invalid-feedback" id="productDescription_error">
											يجب الا يقل وصف المتجر عن 10 احرف ولا يزيد عن 100 حرف
										</div>
									  </div>
									<div class="col-md-8 mt-4">
									  <label for="validationCustom03" class="form-label">تفاصيل المتجر</label>
									  ...
									  <div class="invalid-feedback" id="productDetalis_error">
										يجب الا يقل تفاصيل المتجر عن 30 احرف ولا يزيد عن 300 حرف
									</div>
									</div>
									<div class="col-md-4 mt-4">
										...
										<div class="invalid-feedback" id="price_error">
											يجب الا يقل سعر المتجر عن عن 1 ولا يزيد عن 5 ارقام
										</div>
									  </div>
									<div class="col-md-4 mt-4">
