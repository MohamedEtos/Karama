							...
							<div class="card-body">
								<form id="newuser" action="{{Route('updateUser')}}" method="post" class="row g-3 needs-validation" enctype="multipart/form-data" novalidate >
									...
									<div class="col-md-4 mt-4">
									  ...
									  <input type="text" minlength="3" name="name" value="{{$user->name}}" maxlength="15" class="form-control" placeholder="قم بكتابه اسم المتجر بشكل واضح" id="validationCustom01" required>
								   ...
								   @enderror
									...
									<div class="col-md-4 mt-4">
										...
										<input type="email" minlength="3" name="email" maxlength="20" value="{{$user->email}}" class="form-control" placeholder="karam@karam.com" id="validationCustom01" required>
										<div class="valid-feedback">
										  ممتاز !
										</div>
									  ...
									  <div class="col-md-4 mt-4 ">
										...
										minlength="1" maxlength="12"   type="number" value="{{$user->userToDetalis->phone}}"   id="phone" placeholder=" هاتف المشترك"   >
										<div class="valid-feedback">
											ممتاز !
										</div>
									  ...
									  <div class="col-md-4 mt-4 ">
										...
										<input name="whatsapp" class="form-control" value="{{$user->userToDetalis->whatsapp}}"
									  ...
									  <div class="col-md-4 mt-4 ">
										...
										value="{{$user->userToDetalis->startOfSubscription}}"
									  ...
									  <div class="col-md-4 mt-4 ">
										...
										value="{{$user->userToDetalis->nationalId}}"
