...
<div class="modal-content modal-content-demo">
    ...
    <div class="modal-body">
        <form method="post" action="{{route('store.user')}}" id="storeUser">
            @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input name="phone_number" id="phone_number" type="tel" autofocus class="form-control @error('name') is-invalid @enderror">
            @error('descrption')
            <div class="text-danger">
                {{$message}}
            </div>
        ...
        <div class="mb-3">
            ...
            <input name="email" id="email" type="email" autofocus class="form-control @error('name') is-invalid @enderror">
            @error('descrption')
            <div class="text-danger">
                {{$message}}
            </div>
        ...
        <div class="mb-3">
            ...
            <input name="password" id="password" type="text" autofocus class="form-control @error('name') is-invalid @enderror">
            @error('descrption')
            <div class="text-danger">
                {{$message}}
            </div>
